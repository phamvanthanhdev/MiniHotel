...
public class ThongTinCartItemAdapter extends RecyclerView.Adapter<ThongTinCartItemAdapter.RecentsViewHolder> {
    Context context;
    List<CartItem> items;

    public ThongTinCartItemAdapter(Context context, List<CartItem> items) {
    ...
    public RecentsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.thong_tin_cart_item, null);
